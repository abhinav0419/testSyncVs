...
<Profile xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <applicationVisibilities>
        <application>form_titan</application>
        <default>false</default>
        <visible>true</visible>
    </applicationVisibilities>
    <applicationVisibilities>
    ...
    <classAccesses>
        <apexClass>MaintenaceRequestTest</apexClass>
        <enabled>false</enabled>
    </classAccesses>
    <classAccesses>
    ...
    <classAccesses>
        <apexClass>TestingController</apexClass>
        <enabled>false</enabled>
    </classAccesses>
    <classAccesses>
    ...
    <fieldPermissions>
        <editable>true</editable>
        <field>Test_Object__c.NNN__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
    ...
    <fieldPermissions>
        <editable>true</editable>
        <field>Work_Part__c.Product__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <layoutAssignments>
    ...
    <pageAccesses>
        <apexPage>cascadingSelectTable</apexPage>
        <enabled>false</enabled>
    </pageAccesses>
    <pageAccesses>
        <apexPage>cascadingtablesusingfilter</apexPage>
        <enabled>false</enabled>
    </pageAccesses>
    <pageAccesses>
        <apexPage>formtitan</apexPage>
        <enabled>false</enabled>
    </pageAccesses>
    <pageAccesses>
        <apexPage>ttt</apexPage>
        <enabled>false</enabled>
    </pageAccesses>
